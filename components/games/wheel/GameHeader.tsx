...
import { Menu, X, Trophy, Coins, Sparkles, LogOut, User, ArrowLeft } from 'lucide-react';
import { useRouter } from 'next/navigation';
import BalancePill from '@/components/launcher/BalancePill';
    ...
    <>
      <header className="flex items-center justify-between w-full mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <BalancePill balance={balance} xp={xp} />
        </div>
      </header>
